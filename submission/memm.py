...
class Memm:
    ...
    def __init__(self, model_name, n_years=None):
        ...
        self.train_path = '/home/student/Desktop/ML/Creative Part/CP_2.0_sequence_training_generated/by_season/CP_{}df_{}_train.csv'.format(str(n_years), self.model_name)
        ...
        self.model_dir = '/home/student/Desktop/ML/MEMM/saves/by_season/{}/{}'.format(str(n_years), self.model_name)
        ...
        self.cate = [' _fog', ' _hail', ' _rain', ' _snow', ' _thunder', ' _tornado', 'night', 'morning',
        ...
        for freq_range in [[str(i) for i in range(1, 13)],  # month
            ...
            for freq_part in freq_range:
                for day_part in ['all', 'night', 'morning', 'noon', 'evening']:
                    if freq_part == 'full' or freq_part in [str(i) for i in range(1, 13)] \
                            or day_part == 'all':
                        continue
                    print('\n')
